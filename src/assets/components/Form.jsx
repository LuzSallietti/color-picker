...
const Form = ({handleFetchValues}) => {
        ...
        Yup.lazy(() =>
          Yup.object().shape({
            ...
            color: Yup.string()
                ...
                .matches(VALID_COLOR_REGEX,'El código de color debe estar compuesto por números de 0 a 9 y/o letras de A a F.')            
          })
        )
      )
    ...
    return(
        <CustomForm onSubmit={handleSubmit}>
            ...
            { 
                errors["name"] && (
                  <p style={{ color: "red", fontSize: "12px", padding: 0, margin: 0 }}>{errors["name"]}</p>
                )
            }
            <Label>Color</Label>
            <CustomInput
            ...
            />            
              {errors["color"] && (
                      <p style={{ color: "red", fontSize: "12px", padding: 0, margin: 0 }}>{errors["color"]}</p>
                    )            
            }        
